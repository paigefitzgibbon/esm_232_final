...
maximum_e <- rbind(Cues, Squaw, Burnside, Leavitt)
...
ggplot(max_e) + 
  geom_boxplot(aes(y = warm, col = "Cues")) +
  geom_boxplot(aes(y = warm_squaw, col = "Squaw Valley")) +
  geom_boxplot(aes(y = warm_burnside, col = "Burnside")) +
geom_boxplot(aes(y = warm_leavit, col = "Leavitt Meadow")) +
  theme_classic() + 
  ylab("Energy Required (J m-2)") +
  xlab("Time Step") +
  ggtitle("Energy Requirment for Warming Phase Across\nVarious Sierra Nevada Snowpacks") +
  labs(colour = "Snowpack")
